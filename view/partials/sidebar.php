...
<div class="sidebar">
  ...
  <ul class="space-y-2 font-medium">
    ...
    <li >
      <a href="/DocuCare/record.php" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-400 group">
    ...
    <li>
      <a href="/DocuCare/appointment.php" class=" flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-400 group">
    ...
    <li >
      <a href="/DocuCare/schedules.php" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-400 group">
    ...
    <li>
      <a href="/DocuCare/inventory.php" class=" flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-400 group">
